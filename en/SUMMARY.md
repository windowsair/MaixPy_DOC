...
- [Before read](get_started/how_to_read.md)

## Prepare

- [Get Hardware](get_started/get_hardware.md)
- [Prepare knowledge](get_started/prepare_knowledge.md)
- [Install driver](get_started/install_driver.md)
- [Upgrade firmware](get_started/upgrade_firmware.md)
- [terminal tools](get_started/serial_tools.md)
- [Install MaixPyIDE(optional)](get_started/maixpyide.md)
...
- [Upload script](get_started/upload_script.md)
- [Auto start](get_started/boot.md)
...
## Advanced 1 - Custom Firmware

- [Custom Firmware-Compile](advanced/compile.md)
- [Code structure](advanced/code_struct.md)
- [Pack SPIFFS](advanced/pack_fs.md)
...
- [Related projects](others/open_projects.md)
